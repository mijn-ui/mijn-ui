...
export const checkboxStyles = cva(
  ...
  ],
  {
    variants: {
      variant: {
        default:
          "indeterminate:border-primary indeterminate:bg-primary [&+span>svg]:text-primary-foreground checked:border-primary checked:bg-primary",
        secondary:
          "indeterminate:border-secondary indeterminate:bg-secondary [&+span>svg]:text-secondary-foreground checked:border-secondary checked:bg-secondary",
        outline: "[&+span>svg]:text-black",
        danger:
          "indeterminate:border-danger indeterminate:bg-danger [&+span>svg]:text-danger-foreground checked:border-danger checked:bg-danger",
        success:
          "indeterminate:border-success indeterminate:bg-success [&+span>svg]:text-success-foreground checked:border-success checked:bg-success",
      },
    },
    defaultVariants: {
      variant: "default",
...
const CheckboxWithIndeterminate = forwardRef<HTMLInputElement, CheckboxProps>(
  (
...
const Checkbox = forwardRef<HTMLInputElement, CheckboxProps>(
  ({ variant, id = useId(), className, ...props }, ref) => {
    return (
      <div className="inline-flex items-center gap-2">
